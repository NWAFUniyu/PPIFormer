...
ResultFile=['VirusPathogenDistance' int2str(BLOUSUMno) '.mat'];
%% STEP 1: Load Viral Protein Sequences
%%load VirusHost.mat VirusHostProteinUnique
%%[~, SeqV]=fastaread('VirusHostFinalX.fasta');
load VirusPathogen.mat VirusProteinUnique
[~, SeqV]=fastaread('VirusPathogenFinalX.fasta');
VpCount=length(SeqV);
