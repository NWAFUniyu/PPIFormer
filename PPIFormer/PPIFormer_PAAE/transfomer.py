...
class ScaledDotProductAttention(Layer):
    ...
    def __init__(self, masking=True, future=False, dropout_rate=0.1, **kwargs):#0.
...
class MultiHeadAttention(Layer):
    ...
    def __init__(self, n_heads, head_dim, dropout_rate=0.1, masking=False, future=False, trainable=True, **kwargs):#.1
...
class Transformer(tf.Module):
    def __init__(self, model_dim=64, #model_dim=64
                 n_heads=8,#
                 encoder_stack=3,
        ...
        self.feedforward =  PositionWiseFeedForward(self._model_dim // self._n_heads * self._n_heads, self._feed_forward_size)#(self._model_dim, self._feed_forward_size)
    ...
    def __call__(self, inputs):
        ...
        #100 to 96
        encodings = Dense(self._model_dim // self._n_heads * self._n_heads)(encodings)
        # Dropout
