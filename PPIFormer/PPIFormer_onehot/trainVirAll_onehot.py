...
class roc_callback(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        self.model.save_weights("./model_onehot/virus/all/AllModel%d.h5" %epoch)
...
name = 'All'
os.makedirs('./model_onehot/virus/all/', exist_ok=True)
print("training on All")
Data_dir = 'predata_onehot/train/virus/all/'
max_len_pr1 = 2000
max_len_pr2 = 2000
emb_dim = 100
